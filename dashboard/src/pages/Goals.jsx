export default function Goals() {
  return (
    <div>
      ...
      <p style={styles.subtitle}>Set and manage your upsell revenue goals.</p>
      <div style={styles.card}>
        <p style={styles.placeholder}>Goals management coming soon. This page will connect to your Remix backend.</p>
      </div>
    </div>
  )
}
