export default function Guardrails() {
  return (
    <div>
      <h1 style={styles.title}>Guardrails</h1>
      <p style={styles.subtitle}>Set safety limits and rules for upsell offers.</p>
      <div style={styles.card}>
        <p style={styles.placeholder}>Guardrails config coming soon. This page will connect to your Remix backend.</p>
      </div>
    </div>
  )
}
