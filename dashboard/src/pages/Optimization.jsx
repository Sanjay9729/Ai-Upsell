export default function Optimization() {
  return (
    <div>
      <h1 style={styles.title}>Optimization</h1>
      <p style={styles.subtitle}>AI-driven upsell offer optimization controls.</p>
      <div style={styles.card}>
        <p style={styles.placeholder}>Optimization controls coming soon. This page will connect to your Remix backend.</p>
      </div>
    </div>
  )
}
