export default function ActivityLogs() {
  return (
    <div>
      ...
      <p style={styles.subtitle}>Track all upsell events and merchant activity.</p>
      <div style={styles.card}>
        <p style={styles.placeholder}>Activity logs coming soon. This page will connect to your Remix backend.</p>
      </div>
    </div>
  )
}
