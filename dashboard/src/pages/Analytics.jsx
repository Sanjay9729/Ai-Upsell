export default function Analytics() {
  return (
    <div>
      ...
      <p style={styles.subtitle}>View upsell performance and revenue insights.</p>
      <div style={styles.card}>
        <p style={styles.placeholder}>Analytics dashboard coming soon. This page will connect to your Remix backend.</p>
      </div>
    </div>
  )
}
