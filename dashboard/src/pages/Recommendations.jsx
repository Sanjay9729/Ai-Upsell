export default function Recommendations() {
  return (
    <div>
      ...
      <p style={styles.subtitle}>Configure AI-powered product recommendations.</p>
      <div style={styles.card}>
        <p style={styles.placeholder}>Recommendations config coming soon. This page will connect to your Remix backend.</p>
      </div>
    </div>
  )
}
